...
function renderDropDown(drop_down_data) {
    ...
    const drop_down_select = `<div class="dropDownMsg"><select id="single_select" class="browser-default dropDownSelect"> <option value="" disabled selected>Choose your option</option>${drop_down_options}</select></div>`;
