...
function renderMultiDropDwon(drop_down_data) {
    ...
    const drop_down_select = `<div class="multiDropDownMsg"><select id="multi_select" class="browser-default multiDropDownSelect" multiple> <option value="" disabled selected>Choose your option(s)</option>${drop_down_options}</select><input type="button" id="submit_values" value="send"/></div>`;
