...
function renderDropDwon(drop_down_data) {
    ...
    const drop_down_select = `<div class="dropDownMsg"><select class="browser-default dropDownSelect"> <option value="" disabled selected>Choose your option(s)</option>${drop_down_options}</select></div>`;
